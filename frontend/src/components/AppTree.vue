...
<template>
  ...
  <div col start h-screen w-48 p-4 bg-secondary sh>
      ...
      <Icon :icon="topVisible ? 'mdi-chevron-double-up':'mdi-chevron-double-down'" class="scale cp" 
...
<div v-if="topVisible">
    <div v-if="!visible">
      ...
      <div my-4 p-2 w-40 bg-transparent text-white font-extrabold v-if="!tab">
        <VTextField v-model="owner" label="Owner" placeholder="Owner  " />
        <VTextField
          v-model="repo"
          label="Repo"
          placeholder="Repo"
